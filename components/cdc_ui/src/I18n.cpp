...
constexpr I18nEntry kCoreStrings[] = {
    ...
    {"core.firmware_check",     "Firmware Check"},
    {"core.fw_api_level",       "API Level"},
    {"core.fw_checking",        "Checking for updates..."},
    {"core.fw_up_to_date",      "You are up to date."},
    {"core.fw_update_available","Update available:"},
    {"core.fw_check_failed",    "Update check failed."},
    {"core.fw_needs_wifi",      "Update check needs WiFi (not connected)."},
    {"core.fw_recheck_hint",    "[Y] Check  [N] Back"},
    {"core.name",               "Name"},
    {"core.info",               "Info"},
    {"core.info2",              "Info 2"},
    ...
    {"core.vfat",               "vFAT"},
    {"core.files",              "Files"},
    {"core.system_files",       "System Files"},
    {"core.yes",                "Yes"},
    {"core.no",                 "No"},
    {"core.on",                 "On"},
    {"core.off",                "Off"},
    ...
    {"core.ble_forget_all",     "Forget all bonds"},
    {"core.ble_forget_all_confirm", "Forget all paired devices?"},
    {"core.ble_bonds_cleared",  "Bonds cleared"},
    ...
    {"core.msg_beacon_off",     "Beacon: off"},
    {"core.msg_beacon_name",    "Beacon name"},
    {"core.msg_beacon_scan",    "Beacon scan"},
    {"core.msg_pick_peer",      "Select badge"},
    {"core.msg_searching",      "Searching for badges..."},
    {"core.msg_offer_title",    "Incoming transfer"},
    {"core.msg_offer_from",     "%s wants to send you:"},
    {"core.msg_text",           "Text message"},
    {"core.msg_data",           "Data"},
    {"core.msg_sending",        "Sending..."},
    {"core.msg_receiving",      "Receiving..."},
    {"core.msg_transfer_ok",    "Transfer complete"},
    {"core.msg_transfer_fail",  "Transfer failed"},
    {"core.msg_declined",       "Declined"},
    {"core.msg_unsupported",    "Type not supported"},
    {"core.feature_missing",    "No plugin for this feature"},
    ...
    {"core.shipping_mode",      "Shipping Mode"},
    {"core.shipping_mode_q",    "Enter shipping mode? Disconnects the battery."},
    ...
    {"core.md_truncated",       "-- truncated --"},
    {"core.hint_image",         "[5] Zoom [2/4/6/8] Pan [N] Back"},
    {"core.img_too_large",      "Image too large"},
    {"core.img_unsupported",    "Unsupported image"},
    {"core.img_decode_failed",  "Cannot decode image"},
    ...
    {"core.plugin_stop_bg",     "Stop background"},
